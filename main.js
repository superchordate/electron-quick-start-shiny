...
const MACOS = "darwin"
const WINDOWS = "win32"
//const cmdStr = ".\\R\\bin\\RScript.exe -e \"shiny::runApp('shinyApp.R', port="+port+")\"";
//ShinyProjects\MarketSizing\Market_sizing_Cardinal-master-b823f3aa918475f5d56f01aec9763ed860715158\mrktsiz_no_crosstalk

var killStr = ""
var appPath = path.join(app.getAppPath(), "app" )
var execPath = "RScript"

if(process.platform == WINDOWS){
  //killStr = "taskkill /im Rscript.exe /f"
  appPath = appPath.replace(/\\/g, "\\\\");
  execPath = path.join(app.getAppPath(), "R", "bin", "RScript.exe" )
} else if(process.platform == MACOS){
  //killStr = 'pkill -9 "R"'
  //execPath = "export PATH=\""+path.join(app.getAppPath(), "R-Win")+":$PATH\"
  var macAbsolutePath = path.join(app.getAppPath(), "R")
  ...
  execPath = path.join(app.getAppPath(), "R", "bin", "R" )
} else {
